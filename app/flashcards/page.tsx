    ...
    <div className="flex flex-col items-center gap-6 w-full max-w-sm mx-auto text-center py-8">
      ...
      <div className="flex gap-3 w-full">
        ...
        <button
          ...
          style={{ background: "linear-gradient(135deg, #FF6B35, #C84B15)", boxShadow: "0 4px 16px rgba(255,107,53,0.3)" }}
        >
          Recommencer →
        </button>
      </div>
            ...
            >
              {(["session", "programme"] as const).map((t) => (
                <button
                  ...
                  style={tab === t
                    ? { background: "linear-gradient(135deg, #FF6B35, #C84B15)", color: "white", boxShadow: "0 2px 8px rgba(255,107,53,0.3)" }
                    : { color: C.textMid }
                  }
                >
