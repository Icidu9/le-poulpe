...
const NAV = [
  ...
  { id: "flashcards",   label: "Fiches de révision", icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="6" width="20" height="14" rx="2"/><path d="M16 2H8a2 2 0 0 0-2 2v2h12V4a2 2 0 0 0-2-2z"/></svg>, path: "/flashcards" },
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // Charge le nb de copies
    const e = localStorage.getItem("poulpe_examens");
    if (e) {
      try {
        const parsed = JSON.parse(e);
        setNbCopies(Array.isArray(parsed) ? parsed.length : 0);
      } catch {}
    }
              ...
              <div className="flex flex-col items-center gap-3 py-3">
                ...
                {!flashcardsReady ? (
                  ...
                  <button
                    ...
                    style={{ background: "#EBF5EE", color: "#2D7A4F", border: "1px solid #B8DFC5" }}
                  >
                    ✓ Fiches créées → Voir mes fiches de révision
                  </button>
                )}
